...
const PROGRAM_MAP: Record<string, { name: string, category: RegNoDetails['programCategory'], duration: number }> = {
    ...
    'MCA': { name: 'Integrated M.Tech', category: 'Computer Science', duration: 5 },
    'MIA': { name: 'Integrated M.Tech', category: 'Computer Science', duration: 5 },
    'MDT': { name: 'Integrated M.Tech', category: 'Computer Science', duration: 5 },
    'MIS': { name: 'Integrated M.Tech', category: 'Computer Science', duration: 5 }
};
