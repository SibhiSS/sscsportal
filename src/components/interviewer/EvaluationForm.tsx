        ...
        <div className="bg-white/5 border border-white/10 rounded-xl p-4 space-y-4">
          <div className="flex flex-wrap gap-2 mb-4">
            ...
            {application.portfolioUrl && (
              <Button size="sm" variant="outline" className="border-white/10 hover:bg-white/10 h-8 text-xs text-blue-400" onClick={() => window.open(application.portfolioUrl, '_blank')}>
                Portfolio / Link
              </Button>
            )}
            {/* @ts-ignore */}
            {application.resumeUrl && (
              /* @ts-ignore */
              <Button size="sm" variant="outline" className="border-white/10 hover:bg-white/10 h-8 text-xs text-rose-400" onClick={() => window.open(application.resumeUrl, '_blank')}>
                View Resume
              </Button>
            )}
